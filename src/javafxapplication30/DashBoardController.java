...
public class DashBoardController implements Initializable {
    ...
    @FXML
    private void availableFDUpdate(ActionEvent event) {
        ...
        @FXML
    private void availableFDDelete(ActionEvent event) {
    ...
    public void availableFDShowData() {
     ...
     public void availableFDSelect() {
        ...
        System.out.println(catData.getName());
    ...
    private String[] categories = {"Available", "Not Available"};
    ...
    private String[] type = {"Meals", "Drinks"};
    ...
    @FXML
    private void orderAmount(ActionEvent event) {
        orderTotal();

        Alert alert;

        if ("".equals(order_amount.getText()) ||order_amount.getText().isEmpty() || order_amount.getText()==null) {
            alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText(null);
    ...
    @FXML
    private void orderPay(ActionEvent event) {
        ...
        try {
            ...
            if (String.valueOf(totalP) == null || balance == 0 || "$0.0".equals(String.valueOf(balance)) || String.valueOf(balance) == null
                    || totalP == 0 || "$0.0".equals(String.valueOf(totalP))) {
                alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
    ...
    @FXML
    private void orderReceipt(ActionEvent event) {
    }
    ...
    public void orderRemove() {
        ...
        try {
            ...
            if (item == 0 || String.valueOf(item) == null || "".equals(String.valueOf(item))) {
                alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
